    ...
    <div className="w-full max-w-lg mx-4">
      ...
      >
        <div className="mb-3">
          ...
          />
          {state?.errors?.email && (
            <p className="mt-1 text-base text-red-800">{state.errors.email[0]}</p>
          )}
        </div>
        <div className="mb-4">
          ...
          {state?.errors?.username && (
            <p className="mt-1 text-base text-red-800">{state.errors.username[0]}</p>
          )}
        </div>
        <div className="mb-4">
          ...
          {state?.errors?.password && (
            <p className="mt-1 text-base text-red-800">{state.errors.password[0]}</p>
          )}
        </div>
        <div className="mb-8">
          ...
          {state?.errors?.confirmPassword && (
            <p className="mt-1 text-base text-red-800">{state.errors.confirmPassword[0]}</p>
          )}
        </div>
