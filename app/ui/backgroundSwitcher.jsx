...
export default function BackgroundSwitcher() {
  ...
  return (
    <label htmlFor="background" className="inline-flex items-center cursor-pointer">
      ...
      />
      <div className="relative w-11 h-6 bg-background peer-checked:bg-backgroundImage peer-checked:bg-[length:300px_100px] rounded-full peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-primary after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
    </label>
  );
}
